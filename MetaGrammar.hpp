...
public:
    vector<Rule*> NecessaryRules = {
        ...
        new Rule(CLAUSE, 3, /* associativity = */ Rule::Associativity::NONE, ClauseFactory::ast(LABEL_AST, ClauseFactory::seq(ClauseFactory::ast(LABEL_NAME_AST, ClauseFactory::ruleRef(IDENT)), ClauseFactory::ruleRef(WSC), ClauseFactory::c(':'), ClauseFactory::ruleRef(WSC), ClauseFactory::ast(LABEL_CLAUSE_AST, ClauseFactory::ruleRef(CLAUSE)), ClauseFactory::ruleRef(WSC)))),
        new Rule(CLAUSE, 2, /* associativity = */ Rule::Associativity::NONE, ClauseFactory::ast(SEQ_AST, ClauseFactory::seq(ClauseFactory::ruleRef(CLAUSE), ClauseFactory::ruleRef(WSC), ClauseFactory::oneOrMore(ClauseFactory::seq(ClauseFactory::ruleRef(CLAUSE), ClauseFactory::ruleRef(WSC)))))),
        new Rule(CLAUSE, 1, /* associativity = */ Rule::Associativity::NONE, ClauseFactory::ast(FIRST_AST, ClauseFactory::seq(ClauseFactory::ruleRef(CLAUSE), ClauseFactory::ruleRef(WSC), ClauseFactory::oneOrMore(ClauseFactory::seq(c('/'), ClauseFactory::ruleRef(WSC), ClauseFactory::ruleRef(CLAUSE), ClauseFactory::ruleRef(WSC)))))),
        new Rule(WSC, ClauseFactory::zeroOrMore(ClauseFactory::first(ClauseFactory::c(' ', '\n', '\r', '\t'), ClauseFactory::ruleRef(COMMENT)))),
        new Rule(COMMENT, ClauseFactory::seq(ClauseFactory::c('#'), ClauseFactory::zeroOrMore(ClauseFactory::c('\n').invert()))),
        new Rule(IDENT, ClauseFactory::ast(IDENT_AST, ClauseFactory::seq(ClauseFactory::ruleRef(NAME_CHAR), ClauseFactory::zeroOrMore(ClauseFactory::first(ClauseFactory::ruleRef(NAME_CHAR), ClauseFactory::cRange('0', '9')))))),
        new Rule(NUM, ClauseFactory::oneOrMore(ClauseFactory::cRange('0', '9'))),
        new Rule(NAME_CHAR, ClauseFactory::c(ClauseFactory::cRange('a', 'z'), ClauseFactory::cRange('A', 'Z'), ClauseFactory::c('_', '-'))),
        new Rule(PREC, ClauseFactory::seq(ClauseFactory::c('['), ClauseFactory::ruleRef(WSC), ClauseFactory::ast(PREC_AST, ClauseFactory::ruleRef(NUM)), ClauseFactory::ruleRef(WSC), ClauseFactory::optional(ClauseFactory::seq(c(','), ClauseFactory::ruleRef(WSC), ClauseFactory::first(ClauseFactory::ast(R_ASSOC_AST, ClauseFactory::first(ClauseFactory::c('r'), ClauseFactory::c('R'))), ClauseFactory::ast(L_ASSOC_AST, ClauseFactory::first(ClauseFactory::c('l'), ClauseFactory::c('L')))), ClauseFactory::ruleRef(WSC))), ClauseFactory::c(']'), ClauseFactory::ruleRef(WSC))),
        new Rule(CHAR_SET, ClauseFactory::first(ClauseFactory::seq(ClauseFactory::c('\''), ClauseFactory::ast(SINGLE_QUOTED_CHAR_AST, ClauseFactory::ruleRef(SINGLE_QUOTED_CHAR)), ClauseFactory::c('\'')), ClauseFactory::seq(ClauseFactory::c('['), ClauseFactory::ast(CHAR_RANGE_AST, ClauseFactory::seq(ClauseFactory::optional(ClauseFactory::c('^')), ClauseFactory::oneOrMore(ClauseFactory::first(ClauseFactory::ruleRef(CHAR_RANGE), ClauseFactory::ruleRef(CHAR_RANGE_CHAR))))), ClauseFactory::c(']')))),
        new Rule(SINGLE_QUOTED_CHAR, ClauseFactory::first(ClauseFactory::ruleRef(ESCAPED_CTRL_CHAR), ClauseFactory::c('\'').invert())),
        new Rule(CHAR_RANGE, ClauseFactory::seq(ClauseFactory::ruleRef(CHAR_RANGE_CHAR), ClauseFactory::c('-'), ClauseFactory::ruleRef(CHAR_RANGE_CHAR))),
        new Rule(CHAR_RANGE_CHAR, ClauseFactory::first(ClauseFactory::c('\\', ']').invert(), ClauseFactory::ruleRef(ESCAPED_CTRL_CHAR), ClauseFactory::str("\\-"), ClauseFactory::str("\\\\"), ClauseFactory::str("\\]"), ClauseFactory::str("\\^"))),
        new Rule(QUOTED_STRING, ClauseFactory::seq(ClauseFactory::c('"'), ClauseFactory::ast(QUOTED_STRING_AST, ClauseFactory::zeroOrMore(ClauseFactory::ruleRef(STR_QUOTED_CHAR))), ClauseFactory::c('"'))),
        new Rule(STR_QUOTED_CHAR, ClauseFactory::first(ClauseFactory::ruleRef(ESCAPED_CTRL_CHAR), ClauseFactory::c('"', '\\').invert())),
        new Rule(HEX, ClauseFactory::c(ClauseFactory::cRange('0', '9'), ClauseFactory::cRange('a', 'f'), ClauseFactory::cRange('A', 'F'))),
        new Rule(ESCAPED_CTRL_CHAR, ClauseFactory::first(ClauseFactory::str("\\t"), ClauseFactory::str("\\b"), ClauseFactory::str("\\n"), ClauseFactory::str("\\r"), ClauseFactory::str("\\f"), ClauseFactory::str("\\'"), ClauseFactory::str("\\\""), ClauseFactory::str("\\\\"), ClauseFactory::seq(ClauseFactory::str("\\u"), ClauseFactory::ruleRef(HEX), ClauseFactory::ruleRef(HEX), ClauseFactory::ruleRef(HEX), ClauseFactory::ruleRef(HEX)))),
        new Rule(NOTHING, ClauseFactory::ast(NOTHING_AST, ClauseFactory::seq(ClauseFactory::c('('), ClauseFactory::ruleRef(WSC), ClauseFactory::c(')')))),
        new Rule(START, ClauseFactory::ast(START_AST, ClauseFactory::c('^')))
    };
